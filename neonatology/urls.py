...
urlpatterns = [
    ...
    path('noworodek/<int:dziecko_id>/parametry/dodaj/', views.dodaj_parametry, name='dodaj_parametry'),
    path('noworodek/<int:dziecko_id>/apgar/dodaj/', views.dodaj_apgar, name='dodaj_apgar'),
